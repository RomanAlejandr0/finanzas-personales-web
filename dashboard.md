...
> Última revisión: 23 de agosto de 2026. Este documento es un resumen; el código y las migraciones son la fuente de detalle.
...
- Vista de compromisos para consultar el próximo pago, pausar, reanudar o cancelar; los cancelados se pueden eliminar definitivamente si no tienen pagos confirmados. Al confirmar uno, se registra como transacción real.
...
- Usa las RPC `initialize_personal_universe`, `create_asset_account`, `update_asset_account`, `record_balance_snapshot`, `create_commitment`, `pause_commitment`, `resume_commitment`, `cancel_commitment`, `delete_cancelled_commitment`, `fulfill_commitment_occurrence` y `get_projected_balance_series`.
